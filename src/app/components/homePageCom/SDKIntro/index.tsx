        ...
        <div className="relative z-10 flex items-center justify-center mx-auto mt-[291px] mb-[326px] ">
          ...
          <div className="w-1/2 flex flex-col">
            ...
            <div className="font-light text-white lg:pr-24 text-[54px]">
              <span className={styles.gtheeasiest}>The easiest way to</span>{' '}
              <span className={styles.gthebuild}>build on top of Ref</span>
            </div>
            ...
            <div className="flex items-center mt-[60px]">
              ...
              <button
                className="flex items-center rounded-lg text-white text-opacity-30 text-lg h-14 px-6 py-4 hover:text-opacity-100"
                onClick={() => {
        ...
        <div className="w-full h-[295px] frcc">
          ...
          <div className="pt-[160px]">
            ...
            <div className="font-light text-white lg:pr-24 text-[40px] fccc">
              <span className={styles.gtheeasiest}>The easiest way</span>{' '}
              <span className={styles.gthebuild}>to build on top</span>
              <span className={styles.gthebuild}> of Ref</span>
            </div>
          </div>
        </div>
        <CodeBlockMobile />

        <div className="flex flex-col items-center my-[60px] px-[20px] relative z-[12]">
          <button
