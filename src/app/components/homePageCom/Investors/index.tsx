...
import { MobileGrid,MobileStar,MobileStarGreen } from '../../icon/SDKIntro';
    ...
    <>
      <div className="relative mx-auto mb-[366px] sm:hidden">
        ...
        <div className="flex justify-end text-[54px] text-white mt-3 font-bold">
          <span className="text-green-10 mr-4">Trusted</span> <span className={styles.gthebest}>by the best</span>
        </div>
      ...
      <div className="relative mx-auto lg:hidden overflow-hidden max-h-[1160px] pb-[300px]">
        <div className="fccc text-white font-thin text-2xl relative w-full h-[295px]">
          ...
          <div className="fccc text-[40px] text-white mt-[40px] font-bold">
            <span className="text-green-10">Trusted</span> <span className={`${styles.gthebest} mt-[12px]`}>by the best</span>
          </div>
        </div>
        ...
        <MobileHands className="absolute left-[0px] top-[260px] w-full h-full"/>
      </div>
    </>
  );
};
